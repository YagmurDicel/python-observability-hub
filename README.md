...
![Ortalama Yanıt Süresi](./images/request_metrics.png.png)
...
![İstek Başarı ve Hata Oranları](./images/request_status.png.png)
...
* Kural: Ortalama gecikme süresi belirlenen kritik eşiğin üzerine çıktığında sistem otomatik olarak Firing (Aktif) konumuna geçer.

![Yüksek Gecikme Uyarısı Aktif](./images/alert_firing.png.png)
